    ...
    <div className={styles.container}>
      <Navbar bg="light" expand="lg">
        ...
        <NavDropdown title="View" id="basic-nav-dropdown">
          <NavDropdown.Item href="/posts/viewFacts">Fact</NavDropdown.Item>
          <NavDropdown.Item href="/posts/viewQuestions">Question</NavDropdown.Item>
          <NavDropdown.Item href="/posts/viewRules">Rule</NavDropdown.Item>
        </NavDropdown>
      </Navbar>
      <main>{children}</main>
    </div>
